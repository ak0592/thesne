...
from thesne.thesne_original.dynamic_tsne import dynamic_tsne
from thesne.thesne_original.plot import plot
...
def main():
    ...
    Xs, y = create_blobs(class_size=20, advection_ratio=0.1, steps=10,
                         random_state=seed)

    Ys = dynamic_tsne(Xs, perplexity=70, lmbda=0.1, verbose=0, sigma_iters=50,
                      random_state=seed, n_epochs=100)
